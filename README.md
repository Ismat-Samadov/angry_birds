...
```
db_url=postgresql://tg_db_owner:npg_c6ePiOdNjb8G@ep-frosty-voice-a2s9itd4-pooler.eu-central-1.aws.neon.tech/tg_db?sslmode=require&channel_binding=require
gemini_api_key=AIzaSyCRLPUyRJyFx9C8fgeEj_2IBjVTl8rLUBU
```
